...
var style_ConvenienceMarkets_42 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
	...
	if (lyr_ConvenienceMarkets_43.getVisible() && zoom < 19) {
    ...
    if (value >= 1500000.000000 && value <= 387065900.000000) {
