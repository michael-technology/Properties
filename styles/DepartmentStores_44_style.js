...
var style_DepartmentStores_44 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
	...
	if (lyr_DepartmentStores_45.getVisible() && zoom < 19) {
    ...
    if (value >= 10000000.000000 && value <= 1834700000.000000) {
