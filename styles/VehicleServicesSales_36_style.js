...
var style_VehicleServicesSales_36 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
	...
	if (lyr_VehicleServicesSales_37.getVisible() && zoom < 19) {
    ...
    if (value >= 7000000.000000 && value <= 1931674600.000000) {
