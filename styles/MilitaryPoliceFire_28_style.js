...
var style_MilitaryPoliceFire_28 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
	...
	if (lyr_MilitaryPoliceFire_29.getVisible() && zoom < 19) {
    ...
    if (value >= 15000000.000000 && value <= 2597855003.000000) {
            style = [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(255,128,0,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 1.9}),fill: new ol.style.Fill({color: 'rgba(231,115,0,' + alpha + ')'}),
