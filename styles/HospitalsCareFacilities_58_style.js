...
var style_HospitalsCareFacilities_58 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
	...
	if (lyr_HospitalsCareFacilities_59.getVisible() && zoom < 19) {
    ...
    if (value >= 90000000.000000 && value <= 2417563400.000000) {
