...
var style_Residential250k400k_79 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (value >= 300000.000000 && value <= 400000.000000) {
            style = [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(180,194,255,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 1.9}),fill: new ol.style.Fill({color: 'rgba(162,176,230,' + alpha + ')'}),
